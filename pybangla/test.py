...
if __name__ == "__main__":
    ...
    # "নাম আর শেষ ৪ সংখ্যা ৪৫৬৭। ওটিপি 938221।",
    # "ধন্যবাদ। তাহলে আপনার জন্ম তারিখ হচ্ছে ১৫ই নভেম্বর, ১৯৯০—ঠিক আছে? আমি আবার নিশ্চিত করছি: আপনার জন্ম তারিখ ১৫-১১-১৯৯০, সঠিক তো? এবার, দয়া করে আপনার যোগাযোগের জন্য সবচেয়ে ভালো ফোন নম্বরটি বলবেন? নম্বরটি ধাপে ধাপে বললে ভালো হয়, যেমন: 01773559379।"
    # " নিশ্চিত করছি—আপনার কোড: ৫৫১০ ৫৫ ৫৫১০ এটি কি সঠিক?",
    # "করছি—আপনার চার ডিজিটের কোড: ৫৩১০ এটি কি সঠিক?"
    # "১৯৯০-১৯৯৫ সালে"
    # "আজকের দাম $50।",
    # "তিনি ৳৫০০ খরচ করেছেন।",
    # "€1,245.75",
    ...
    # "50678.90 ডলার",
    # "2050.8 ইউরো",
    # "আরও যদি অস্বাভাবিক কেস 6,543,21,789,01,23,45678,2050.8 ইউরো আরও যদি অস্বাভাবিক কেস",
    # "আরও যদি অস্বাভাবিক কেস 6,54321,78901,23,45678,2050.8 ইউরো আরও যদি অস্বাভাবিক কেস",

    # # আরও উদাহরণ
    # "আরও যদি অস্বাভাবিক কেস Mixed: A$2,000.99 or 3,000.50€ আরও যদি অস্বাভাবিক কেস",
    # "আরও যদি অস্বাভাবিক কেস $2,00,000.99 should match; also €3.000,50 and 1234,56 EUR আরও যদি অস্বাভাবিক কেস ",
    ...
    # "৳১২৯৩.১২৯৩",
    # "এই প্রক্রিয়াটি আনুমানিক ১০-১৫ মিনিট সময় নিতে পারে। ",
    # "জাতীয় পরিচয় নম্বরঃ ১৯৯০-১৯৯৫ সালে জাতীয় পরিচয় নম্বরঃ 0987654321",
    # "জাতীয় পরিচয় নম্বরঃ 0987-654-321 জাতীয় পরিচয় নম্বরঃ 0987654321"
    # "Card number 98765432 is valid until 12/25.",
    ...
    # 'ধন্যবাদ। আপনি বললেন "হ্যাঁ, এই..."—আপনি কি গাড়ির তথ্য দিতে প্রস্তুত? দয়া করে শুরু করুন গাড়ির ব্র্যান্ড ও মডেল দিয়ে। উদাহরণস্বরূপ: — "Toyota Corolla" — অথবা "Honda City" আপনার গাড়ির ব্র্যান্ড ও মডেলটি বলবেন? আমি এরপর ধাপে ধাপে বাকি তথ্য সংগ্রহ করব।'
    ...
    # "তার পাসপোর্ট নম্বর P০১২৩৪৫৬৭ ছিল।",
    # "বাংলা নম্বর হিসেবে পাসপোর্ট নম্বর এ০১২৩৪৫৬৭ ও ই১২৩৪৫৬৭৮।",
    # "পাসপোর্ট নম্বর এ০১২৩৪৫৬৭ ও ই১২৩৪৫৬৭৮ and এ০১২৩৪৫৬৭ ও ই১২৩৪৫৬৭৮।",
    # "এয়ারলাইনসসহ তিনটি এয়ারলাইনসের ৫১টি ফ্লাইটে মো: ২০ হাজার ২৯১ জন হজযাত্রী সৌদি আরবে গেছেন। এ বছর হজ করতে ৮৫ হাজার ২৫৭ জনের সৌদি আরবে যাওয়ার কথা রয়েছে।",
    # "ডিএসইতে লেনদেন ৩০০ কোটি টাকার নিচে নেমে এসেছে। লেনদেন হয়েছে ২৯০ কোটি ১৩ লাখ টাকার। গতকাল মঙ্গলবার লেনদেন হয়েছে ৩৩৯ কোটি ৭৫ লাখ টাকার।"
    # "এ০১২৩৪৫৬৭ and ABC123 and পাসপোর্ট ৯৮৭ and B456 and USD৯৮৭ standalone",
    # "March 10, 1988 আপনার জন্ম তারিখটি বলুন, দয়া করে।",
    # "আমরা ফেব্রুয়ারি ১৯৯৫ তে স্কিউইং যাব.",
    # "Starlink Standard কিটের জন্য BDT49,500। নির্ভরযোগ্য হাই-স্পিড ইন্টারনেট, যেখানেই যাবেন সেখানেই পাবেন। প্ল্যানের মূল্য শুরু প্রতি মাসে 4,200৳ থেকে।"
    ...
    texts = [
        ...
        # "# তার পাসপোর্ট নম্বর P87654321 ছিল।, 1995  1996 and phone number 01773-550379",
        # "Maria: ধন্যবাদ স্যার। আপনার নাম রফিকুল ইসলাম এবং কানেকশন টাইপ ২০ Mbps হোম প্যাকেজ, তাই তো?",
        # "২৪–২৬ কে দুই চার দুই ছয় রিড করেছে "
        # "হ্যাঁ, অনেক সময় ১৬–১৮ ডিগ্রি দিয়ে রাখি, আর দরজা জানালা বন্ধ থাকে।",
        # "Maria: জি স্যার, এতে অনেক সময় কনডেনসেশন বেশি হয়, পানি জমে, ড্রেন দিয়ে ঠিকমতো বের হতে না পারলে লিকেজ শুরু হয়। ভবিষ্যতে চেষ্টা করবেন ২৪–২৬ ডিগ্রির মধ্যে রাখতে, এতে কুলিংও ভাল থাকবে, আবার "
        # "# জাতীয় পরিচয় নম্বরঃ 0987-654-321 জাতীয় পরিচয় নম্বরঃ 0987654321",
        # "তিনি ₹১০ লাখ দান করেছেন",
        # "তিনি ₹১০ লাখ দান করেছেন",
        # "এই পণ্যটির মূল্য $25.50 লাখ",
        # "আমার ওজন 70kg এবং আমার উচ্চতা 5.9ft।",
    ...
    for text in text_list:
        ...
        print("output : ", text)
        print("Time taken: ", time.time() - inter_start_time)
        print("=" * 30 + "\n")
